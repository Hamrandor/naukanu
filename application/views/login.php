<?php
/**
Hier erzeugen wir unseren Doctype des Dokumentes
in dem Falle ist sofern nichts anderes angegeben wurde als Übergabeparameter
wird der Doctype xhtml verwendet. Ändert sich der Doctype so ändern
sich ebenso die entsprechenden HTML tags die sich dynamisch erzeugen lassen zu dem
entsprechenden Doctype.
*/
echo doctype()."\n";
?>
<html>
    <head>
       <?php
            //Hier wird als <link></link> die CSS-File eingebunden.
            //base_url() ist die Basis-Adresse des Dokumentes
            //http://localhost/<pfad>/
            echo link_tag(base_url().'themes/css/style.css')."\n";
       ?>
       <title>Login</title>
    </head>
    <body>
        ...
        <div class="login-box">
            <?php
                ...
                echo form_label('Domain:', 'username')."\n\t\t";
