<?php
        ...
        echo "Bitte wählen Sie einen Mast aus:<br><br>";
...
//                       echo 'Wählen Sie einen Segel aus:  ';
//                       echo form_dropdown('sSegel', $totalSegelArray, $selectedSegel);
//                       echo '<br>'. form_submit('editSegel', 'Ausgewählten Segel bearbeiten');
//                   } else {
...
//                    echo form_submit('saveSegelButton', 'ausgewählten Segel diesem Boot zuordnen');
//                    
//                }
            }
        }
